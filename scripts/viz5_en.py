# -*- coding: utf-8 -*-
"""English twin of viz5.py. Same data, translated chart text."""
import matplotlib
matplotlib.use('Agg')
...
ax.text(eleicao, len(polls)-0.3, ' election day\n Oct 6, 2024', color=BLUE, fontsize=9, fontweight='bold', fontfamily='Anton', va='top')
...
ax.set_title("REGISTRATION OF THE 9 ELECTION POLLS — ALFREDO CHAVES, 2024", fontsize=13, fontweight='bold', fontfamily='Anton', pad=14)
plt.tight_layout()
b64 = fig_to_b64(fig)
with open(os.path.join(OUT_EN, "chart_pesquisas_timeline.b64"), 'w') as f:
    f.write(b64)
print("Chart generated: pesquisas_timeline")
